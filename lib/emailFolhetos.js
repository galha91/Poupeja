...
<body style="margin:0;padding:0;background:#f3f4f2;font-family:'Segoe UI',Arial,sans-serif;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f2;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" style="max-width:500px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
        ...
        <tr>
          <td style="padding:28px 28px 8px;">
            <p style="margin:0 0 4px;font-size:16px;color:#0f172a;font-weight:700;">Olá, ${primeiroNome}! 👋</p>
            <p style="margin:0 0 22px;font-size:14px;color:#64748b;line-height:1.6;">
              Esta semana há promoções em <strong>${folhetos.length} superfícies</strong>. Vê antes de ires às compras e poupa mais.
            </p>
