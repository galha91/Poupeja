 ...
 *
 * O limiar não é escolhido a olho. Medido na amostra de produção, os
 * mínimos LEGÍTIMOS de cada combustível caem entre 91% e 99% da
 * mediana desse combustível:
 *
 *     Gasolina 98 Aditivada  99%      GPL Auto              91%
 *     Gasolina 95 Aditivada  97%      Gasóleo (anomalia)    68%  ←
 *     Gasolina 95            95%
 *     Gasóleo Aditivado      94%
 *
 * 80% cai no meio do vazio entre os dois grupos, com 11 pontos de
 * folga para o mínimo legítimo mais baixo. Esconder um posto
 * genuinamente barato seria o pior erro que esta app podia cometer —
 * é literalmente aquilo que ela existe para encontrar —, por isso o
 * corte é deliberadamente generoso.
 *
 ...
 */
export const LIMIAR_BAIXO = 0.80;
