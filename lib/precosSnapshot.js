 ...
 *
 * Agora há uma linha no Supabase, reescrita uma vez por dia pelo cron. Quem
 ...
 *
 * Tem de ser maior do que um ciclo do cron, senão deixa de distinguir o
 * que foi feito para distinguir. Com a actualização de hora a hora, uma
 * falha isolada deixava o snapshot com ~1h e não valia um email; só seis
 * horas seguidas a falhar valiam. Agora que a actualização é diária
 * (o plano Hobby do Vercel não deixa mais do que isso), uma falha isolada
 * deixa o snapshot com ~24h — com o limite nas 6h, o PRIMEIRO falhanço
 * mandava email, todos os dias, e o aviso deixava de querer dizer nada.
 *
 * 30h é pouco mais do que um ciclo: um dia falhado não é notícia, dois
 * seguidos são.
 */
export const IDADE_PREOCUPANTE = 30 * 60 * 60 * 1000;
