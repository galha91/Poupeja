...
/* A 98 é a que faltava: quem tem carro a 98 chegava à página do seu concelho
   e via gasóleo, 95 e GPL, tudo menos o combustível que lhe interessa.
   Os concelhos onde a DGEG não a cobre continuam a não mostrar o cartão —
   `dadosMunicipio` deixa cair os tipos sem preço. */
export const TIPOS_DESTAQUE = ["Gasóleo", "Gasolina 95", "Gasolina 98", "GPL Auto"];
