...
const CATS = {
  ...
  "Laticínios": {
    ...
    items: [
      { nome: "Leite", emoji: "🥛" }, { nome: "Iogurte", emoji: "🫙" },
      { nome: "Queijo", emoji: "🧀" }, { nome: "Manteiga", emoji: "🧈" },
      { nome: "Natas", emoji: "🥛" }, { nome: "Ovos", emoji: "🥚" },
    ],
  },
  "Padaria": {
    emoji: "🍞", cor: "#d97706", bg: "#fffbeb",
    items: [
      { nome: "Pão", emoji: "🍞" }, { nome: "Pão de forma", emoji: "🍞" },
      { nome: "Croissant", emoji: "🥐" }, { nome: "Tostas", emoji: "🍞" },
      { nome: "Bolos", emoji: "🧁" }, { nome: "Bolachas", emoji: "🍪" },
    ],
  },
  "Carnes": {
    emoji: "🥩", cor: "#dc2626", bg: "#fff1f2",
    items: [
      { nome: "Frango", emoji: "🍗" }, { nome: "Carne picada", emoji: "🥩" },
      { nome: "Bifes", emoji: "🥩" }, { nome: "Presunto", emoji: "🥓" },
      { nome: "Salsichas", emoji: "🌭" }, { nome: "Atum (lata)", emoji: "🐟" },
      { nome: "Peixe", emoji: "🐠" }, { nome: "Fiambre", emoji: "🍖" },
    ],
  },
  "Bebidas": {
    emoji: "🧃", cor: "#7c3aed", bg: "#f5f3ff",
    items: [
      { nome: "Água", emoji: "💧" }, { nome: "Sumo", emoji: "🧃" },
      { nome: "Leite vegetal", emoji: "🥛" }, { nome: "Cerveja", emoji: "🍺" },
      { nome: "Vinho", emoji: "🍷" }, { nome: "Café", emoji: "☕" },
      { nome: "Chá", emoji: "🍵" }, { nome: "Refrigerante", emoji: "🥤" },
    ],
  },
  "Limpeza": {
    emoji: "🧹", cor: "#0891b2", bg: "#ecfeff",
    items: [
      { nome: "Detergente loiça", emoji: "🧴" }, { nome: "Detergente roupa", emoji: "🧺" },
      { nome: "Papel higiénico", emoji: "🧻" }, { nome: "Sacos do lixo", emoji: "🗑️" },
      { nome: "Limpeza WC", emoji: "🚿" }, { nome: "Esfregão", emoji: "🧹" },
      { nome: "Amaciador", emoji: "🧺" }, { nome: "Desinfetante", emoji: "💧" },
    ],
  },
  "Higiene": {
    emoji: "🧼", cor: "#db2777", bg: "#fdf4ff",
    items: [
      { nome: "Champô", emoji: "🧴" }, { nome: "Gel de banho", emoji: "🚿" },
      { nome: "Pasta dentes", emoji: "🪥" }, { nome: "Desodorizante", emoji: "🧴" },
      { nome: "Creme", emoji: "🧴" }, { nome: "Escova dentes", emoji: "🪥" },
    ],
  },
};
